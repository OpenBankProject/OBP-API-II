...
//
//  lazy val testConsumer = Consumers.consumers.vend.createConsumer(Some(randomString(40).toLowerCase), Some(randomString(40).toLowerCase), Some(true), Some("test application"), 
//    None, Some("description"), Some("eveline@example.com"), Some(selfCallback), 
//    None,
//    None,
//    None,
//    None
...
//
//  lazy val disabledTestConsumer = Consumers.consumers.vend.createConsumer(Some(randomString(40).toLowerCase), 
//    Some(randomString(40).toLowerCase), Some(false), Some("test application disabled"), None, Some("description"), 
//    Some("eveline@example.com"), Some(selfCallback),
//    None,
//    None,
//    None,
//    None
