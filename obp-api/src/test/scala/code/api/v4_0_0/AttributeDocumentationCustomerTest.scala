...
//  object ApiEndpoint1 extends Tag(nameOf(Implementations4_0_0.createOrUpdateCustomerAttributeAttributeDefinition))
//  object ApiEndpoint2 extends Tag(nameOf(Implementations4_0_0.getCustomerAttributeDefinition))
//  object ApiEndpoint3 extends Tag(nameOf(Implementations4_0_0.deleteCustomerAttributeDefinition))
//
//  
...
//      When("We make a request v4.0.0")
//      val request400 = (v4_0_0_Request / "banks" / bankId / "attribute-definitions" / "customer").GET
...
//        / "ATTRIBUTE_DEFINITION_ID" / "customer").DELETE
...
//      When("We make a request v4.0.0")
//      val request400 = (v4_0_0_Request / "banks" / bankId / "attribute-definitions" / "customer").PUT <@ (user1)
//      val response400 = makePutRequest(request400, write(putJson))
...
//      When("We make a request v4.0.0")
//      val request400 = (v4_0_0_Request / "banks" / bankId / "attribute-definitions" / "customer").GET <@ (user1)
//      val response400 = makeGetRequest(request400)
//      Then("We should get a 403")
//      response400.code should equal(403)
//      response400.body.extract[ErrorMessage].message.toString contains (UserHasMissingRoles) should be (true)
...
//      When("We make a request v4.0.0")
//      val request400 = (v4_0_0_Request / "banks" / bankId / "attribute-definitions"
//        / "ATTRIBUTE_DEFINITION_ID" / "customer").DELETE <@ (user1)
//      val response400 = makeDeleteRequest(request400)
//      Then("We should get a 403")
//      response400.code should equal(403)
//      response400.body.extract[ErrorMessage].message.toString contains (UserHasMissingRoles) should be (true)
