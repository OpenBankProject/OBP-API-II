...
object ResourceDocsAPIMethodsUtil extends MdcLoggable{
  ...
  def resourceDocsToResourceDocJson(
  ...
  def resourceDocsJsonToJsonResponse(resourceDocsJson: ResourceDocsJson): JValue = {
    /**
