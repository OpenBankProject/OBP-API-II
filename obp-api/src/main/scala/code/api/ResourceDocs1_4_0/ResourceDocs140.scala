...
object ResourceDocs140 extends OBPRestHelper with ResourceDocsAPIMethodsLegacy with MdcLoggable {
...
object ResourceDocs200 extends OBPRestHelper with ResourceDocsAPIMethodsLegacy with MdcLoggable {
...
// Hack to provide Resource Docs / Swagger on endpoints other than 1.4.0 where it is defined.
object ResourceDocs210 extends OBPRestHelper with ResourceDocsAPIMethodsLegacy with MdcLoggable {
...
// Hack to provide Resource Docs / Swagger on endpoints other than 1.4.0 where it is defined.
object ResourceDocs220 extends OBPRestHelper with ResourceDocsAPIMethodsLegacy with MdcLoggable {
...
// Hack to provide Resource Docs / Swagger on endpoints other than 1.4.0 where it is defined.
object ResourceDocs300 extends OBPRestHelper with ResourceDocsAPIMethodsLegacy with MdcLoggable {
...
//  })
  ...
  // Hack to provide Resource Docs / Swagger on endpoints other than 1.4.0 where it is defined.
  object ResourceDocs310 extends OBPRestHelper with ResourceDocsAPIMethodsLegacy with MdcLoggable {
...
//    })
  ...
  // Hack to provide Resource Docs / Swagger on endpoints other than 1.4.0 where it is defined.
  object ResourceDocs400 extends OBPRestHelper with ResourceDocsAPIMethodsLegacy with MdcLoggable {
...
//    })
  ...
  // Hack to provide Resource Docs / Swagger on endpoints other than 1.4.0 where it is defined.
  object ResourceDocs500 extends OBPRestHelper with ResourceDocsAPIMethodsLegacy with MdcLoggable {
...
//    })
  ...
  object ResourceDocs510 extends OBPRestHelper with ResourceDocsAPIMethodsLegacy with MdcLoggable {
